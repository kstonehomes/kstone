...
export default async function FloorPlanSingle({ params }: Params) {
  ...
  const statusConfig = {
    ready: { color: "bg-emerald-500", text: "Move in Ready " + `${floorPlanData.readyStatus ? `${floorPlanData.readyStatus}` : ""}`, icon: "🟢" },
    pending: { color: "bg-amber-500", text: "Pending ", icon: "🟡" },
    sold: { color: "bg-red-500", text: "Sold Out", icon: "🔴" },
    available: { color: "bg-blue-500", text: "Available " + `${floorPlanData.availableStatus ? `${floorPlanData.availableStatus}` : ""}`, icon: "🔵" }
  } as const;

  const defaultStatus = { color: "bg-gray-500", text: "undefined", icon: "⚪" };
  const currentStatus = floorPlanData.status && floorPlanData.status in statusConfig ? statusConfig[floorPlanData.status as keyof typeof statusConfig] : defaultStatus;
  ...
  return (
    <main className="bg-white">
      <PageHeader
        ...
        backgroundImage="/images/sp-quickpossession.jpg"
        breadcrumbs={[
          { label: "Home", href: "/" },
            ...
            <div className="p-3 md:p-8">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
                 <div>
                                  ...
                                  <h3 className="title text-xl font-medium mb-1 text-gray-500">{floorPlanData.floorPlanModel}</h3>
                ...
                <div className="t-6 lg:mt-0 flex gap-4 md:flex-row flex-col">
                  <ModalButton source={`${floorPlanData.floorPlanModel}, ${floorPlanData.community?.name}`} label="Schedule Visit" />
                  <DownloadPDFButton href={floorPlanData.floorPlanPdf} fileName={floorPlanData.floorPlanFileName} />
                </div>
              </div>
              ...
              <div className="property-features-grid gap-3 md:gap-5">
                              <div className="property-features-col">
                                ...
                                <div className="property-features-content">
                                  <div className="property-features-title">{floorPlanData.allFeatures.sqft.toLocaleString()}</div>
                              ...
                              <div className="property-features-col">
                                ...
                                <div className="property-features-content">
                                  <div className="property-features-title">{floorPlanData.allFeatures.mainHouseSqft.toLocaleString()}</div>
                              ...
                              <div className="property-features-col">
                                ...
                                <div className="property-features-content">
                                  <div className="property-features-title">{floorPlanData.allFeatures.basementSqft}</div>
                              ...
                              <div className="property-features-col">
                                ...
                                <div className="property-features-content">
                                  <div className="property-features-title">{floorPlanData.allFeatures.garageSuiteSqft}</div>
                              ...
                              <div className="property-features-col">
                                ...
                                <div className="property-features-content">
                                  <div className="property-features-title">{floorPlanData.allFeatures.bedrooms}</div>
                              ...
                              <div className="property-features-col">
                                ...
                                <div className="property-features-content">
                                  <div className="property-features-title">{floorPlanData.allFeatures.bathrooms}</div>
              ...
              <div className="py-5">
                <div className="">
                  ...
                  <p className="content">
                    {floorPlanData.shortDescription || `Experience luxury living in the ${floorPlanData.floorPlanModel}, perfectly designed for modern families seeking comfort and elegance.`}
                  </p>
                </div>
              </div>
...
{/* Availability */}
              ...
              <div className="features">
                 ...
                 { floorPlanData.additionalFeatures && ( 
                    <div className="additional-features">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4">
                        {floorPlanData.additionalFeatures?.map((feature: string, i: number) => (
                ...
                { floorPlanData.upgrades && floorPlanData.upgrades.length > 0 && ( 
                  <div className="upgrades py-6">
                  <h3 className="title text-2xl">Upgrades Available<div className="line"></div></h3>
                  <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4">
                    {floorPlanData.upgrades?.map((upgrades: string, i: number) => (
                      <div key={i} className="flex items-center justify-start gap-4 p-4 bg-primary-bg shadow-sm border border-primary hover:shadow-md transition-shadow duration-300">
