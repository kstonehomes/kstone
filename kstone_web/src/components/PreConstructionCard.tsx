...
interface PreConstructionCardProps {
  item: PreConstruction;
}

const PreConstructionCard = ({ item }: PreConstructionCardProps) => {
  const colorStatus = {
  ...
  return (
    <Link href={`/pre-construction/${item.slug}`} className="group relative bg-primary overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-700 hover:-translate-y-3 transform "> 
      {/* Image Container */}
