  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-4 py-6">
      <div className="text-center mb-4">
        ...
        <div className="mt-2 w-16 mx-auto border-t-2 border-primary" />
      </div>

      <select
        id="community-select"
        className="w-full border-2 border-gray-200 bg-white  text-gray-700 px-4 py-2 font-semibold focus:outline-none focus:ring-2 focus:ring-primary transition"
        value={community}
